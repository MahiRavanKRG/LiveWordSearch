...
def on_key_release(event, input_string=[]):  # the event is used to handle the key press event, input_string is used to store the input characters as a list
    ...
    if event.name == "space": # as per the pllaned functionality, space will trigger search
        ...
        print(f" \nLooking on PyDictionary... \n{passing_string} :") # CMD evidence of the input string
        try:
...
print("""Welcome to LiveWordSearch app,
        This app will listen to your keyboard 
        Whenever you press space it will search for the word you typed
        Thats all it does, Thankyou for using my app ❣️
